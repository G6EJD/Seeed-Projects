# Seeed-Projects
Using SEEED products (reTerminal E1001 and XIAO ePaper Board EE04) to create various projects of [ESP32-e-Paper-Weather-Display](https://github.com/G6EJD/ESP32-e-Paper-Weather-Display)

1. Installing
2. Start by downloading all files to a folder (Main file e.g. E1001 or EE04 variant, common, language, credentials)
...
The EE04 can be refreshed using the Reset button.
...
[XIAO EE04 ePaper Board](https://www.seeedstudio.com/XIAO-ePaper-Display-Board-EE04-p-6560.html) with [Seeed 5.83" epaper panel](https://www.seeedstudio.com/5-83-Monochrome-ePaper-Display-with-648x480-Pixels-p-5785.html)
7.5" 800x480 E-Paper Layout
